...
public class MCreatorHue_Palm_Log extends Elementspandora.ModElement {
	@ObjectHolder("pandora:hue_palm_log")
	public static final Block block = null;

	public MCreatorHue_Palm_Log(Elementspandora instance) {
		super(instance, 21);
	}
