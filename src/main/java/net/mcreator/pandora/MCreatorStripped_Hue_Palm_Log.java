...
public class MCreatorStripped_Hue_Palm_Log extends Elementspandora.ModElement {
	@ObjectHolder("pandora:stripped_hue_palm_log")
	public static final Block block = null;

	public MCreatorStripped_Hue_Palm_Log(Elementspandora instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.WOOD).hardnessAndResistance(2f, 10f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("stripped_hue_palm_log");
		}
